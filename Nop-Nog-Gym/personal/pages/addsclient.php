    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4" style="margin-bottom: 10px;">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Treinos do cliente</h6>
                    </div>
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <?php
                                    ...
                                    $sql = "select tbtreinos.codtreino,tbtreinos.nome, tbtreinos.foto, tbtreinos.categoria,tbtreinos.descricao,tbtreinos.repeticoes,tbtreinos.execucoes,tbtreinos.intervalo from tbtreinos
                                    ...
                                    if($select -> num_rows > 0) {
                                        while($linha = $select->fetch_array(MYSQLI_ASSOC)){
                                            ...
                                            echo '<td><img class="rounded-circle me-lg-2" src="data:image/jpeg;base64,'.base64_encode($foto).'" alt="" style="width: 40px; height: 40px;"></td>';
                                            echo '<td>'.$linha['repeticoes'].'</td>';
                                            echo '<td>'.$linha['execucoes'].'</td>';
                ...
                <div class="bg-secondary text-center rounded p-4" style="margin-bottom: 10px;">
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
                                    <th scope="col">Dias de realização dos treinos do cliente</th>
                                </tr>
                            </thead>
                            <tbody>           
                            <?php
                                    $sql = "select * from tbrealizacoes where codusu = $codusu";
                                    ...
                                    if($select -> num_rows > 0) {
                                        while($linha = $select->fetch_array(MYSQLI_ASSOC)){
                                            echo '<tr>';
                                            echo '<td>'.$linha['datarealizacao'].'</td>';
                                            echo '</tr>';
                                        }    
                                    }
                            ?>
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <?php
                                    ...
                                    $sql = "select dica from tbclientedicas
                                            where codusu = $codusu";
                ...
                <div class="bg-secondary rounded h-100 p-4" style="margin-top: 10px;">
                    <h6 class="mb-4">Adicionar dica para o cliente:</h6>
                    <form method="POST" action="../tests/baddsclient.php?codusu=<?php echo $codusu; ?>" enctype="multipart/form-data">
                        <div class="mb-3">
