        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
                                    ...
                                    <th scope="col">Treino e Dicas</th>
                                ...
                                $select = $conexao->query($sql);
                                    if($select->num_rows > 0) {
                                        while($linha = $select->fetch_array(MYSQLI_ASSOC)){
                                            ...
                                            echo '<td><a class="btn btn-sm btn-primary" href="addsclient.php?codusu='.$linha['codusu'].'"><i class="fa fa-edit"></i></a></td>';
                                            echo '<td><a class="btn btn-sm btn-primary" href="alterclients.php?codusu='.$linha['codusu'].'"><i class="fa fa-edit"></i></a></td>';
                                            echo '<td><a class="btn btn-sm btn-primary" href="../tests/deleteclient.php?codusu='.$linha['codusu'].'"><i class="fa fa-trash"></i></a></td>';
                                            echo '</tr>';
                                        }
                                    }    
                            ?>
                ...
                <div class="bg-secondary rounded h-100 p-4" style="margin-top: 10px;">
                    <h6 class="mb-4">Cadastrar cliente</h6>
                    <form method="POST" action="../tests/bsignup.php" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="treinosc" class="form-label">Treinos do cliente(coloque os códigos dos exercícios separados por /)</label>
                            <input type="text" class="form-control" id="treinosc" name="treinosc"
                                aria-describedby="emailHelp">
                        </div>
