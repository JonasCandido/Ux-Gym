        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                                ...
                                $select = $conexao->query($sql);
                                    if($select->num_rows > 0) {
                                        while($linha = $select->fetch_array(MYSQLI_ASSOC)){
                                            ...
                                            echo '<td><a class="btn btn-sm btn-primary" href="altertrains.php?codtreino='.$linha['codtreino'].'"><i class="fa fa-edit"></i></a></td>';
                                            echo '<td><a class="btn btn-sm btn-primary" href="../tests/deletetrain.php?codtreino='.$linha['codtreino'].'"><i class="fa fa-trash"></i></a></td>';
                                            echo '</tr>';
                                        }
                                    }    
                            ?>
                ...
                <div class="bg-secondary rounded h-100 p-4" style="margin-top: 10px;">
                    <h6 class="mb-4">Cadastrar treino</h6>
                    <form method="POST" action="../tests/addtrain.php" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="foto" class="form-label">Foto do exercício:</label>
                        ...
                        <button type="submit" class="btn btn-primary">Aplicar treino</button>
                    </form>
                </div>
            </div>
