        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary rounded h-100 p-4" style="margin-top: 10px;">
                    <h6 class="mb-4">Alterar cliente</h6>
                    <form method="POST" action="../tests/balterclients.php?codusu=<?php echo $codusu; ?>" enctype="multipart/form-data">
                        <div class="mb-3">
                            <?php
                                include('../../bankconnection/conexaobanco.php');
                                $sql = "select * from tbcliente where codusu = $codusu";
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                aria-describedby="emailHelp" value="<?php echo $linha['email']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="senha" class="form-label">Senha</label>
                            <input type="password" class="form-control" id="senha" name="senha"
                                aria-describedby="emailHelp" value="<?php echo $linha['senha']; ?>">
                        </div>
                        <div class="mb-3">
                            <label for="telefone" class="form-label">Telefone</label>
                            <input type="tel" class="form-control" id="telefone" name="telefone"
                                aria-describedby="emailHelp" value="<?php echo $linha['telefone']; ?>">
                        </div>
                        <div class="mb-3">
